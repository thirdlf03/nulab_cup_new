...
{
    /// <summary>
    /// Meta XR Interaction SDK の右手トラッキングからサムズアップ（👍）を検出してキューブをスポーンする。
    ...
    public class CubeSpawner : MonoBehaviour
    {
        ...
        public int SpawnedCubeCount => m_SpawnedCubes.Count;
        public int MaxCubes => m_MaxCubes;
